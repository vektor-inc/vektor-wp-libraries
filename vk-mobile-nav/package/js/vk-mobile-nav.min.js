...
;(function($){function vk_mobile_nav_run(target){jQuery(target).click(function(){if(jQuery(this).hasClass('menu-open')){jQuery(this).removeClass('menu-open');jQuery('.vk-mobile-nav').removeClass('vk-mobile-nav-open');}else{jQuery(this).addClass('menu-open');jQuery('.vk-mobile-nav').addClass('vk-mobile-nav-open');}});}
