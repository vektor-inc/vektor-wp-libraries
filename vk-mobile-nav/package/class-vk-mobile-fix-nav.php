    ...
    public function vk_mobail_fix_nav_customize_register( $wp_customize ) {
      ...
      // link_text セッティング
    	$wp_customize->add_setting(
    		  'vk_mobail_fix_nav_related_options[ link_text ]', array(
    			'default'           => '',
    	...
    	$wp_customize->add_control(
    		  'link_text', array(
    			...
    			'settings' => 'vk_mobail_fix_nav_related_options[ link_text ]',
    			'type'     => 'text',
    		  )
    	);
      ...
      // link_icon セッティング
    	$wp_customize->add_setting(
    		  'vk_mobail_fix_nav_related_options[ link_icon ]', array(
    			'default'           => '',
    			'type'              => 'option', // 保存先 option or theme_mod
    			'capability'        => 'edit_theme_options', // サイト編集者
    			'sanitize_callback' => 'sanitize_text_field',
    	...
    	$wp_customize->add_control(
    		  'link_icon', array(
    			...
    			'section'     => 'vk_mobail_fix_nav_related_setting',
    			'settings'    => 'vk_mobail_fix_nav_related_options[ link_icon ]',
    			'type'        => 'text',
      ...
      // link_url セッティング
    	$wp_customize->add_setting(
    		  'vk_mobail_fix_nav_related_options[ link_url ]', array(
    			'default'           => '',
    			'type'              => 'option', // 保存先 option or theme_mod
    			'capability'        => 'edit_theme_options', // サイト編集者
    			'sanitize_callback' => 'sanitize_text_field',
    	...
    	$wp_customize->add_control(
    		  'link_url', array(
    			...
    			'section'     => 'vk_mobail_fix_nav_related_setting',
    			'settings'    => 'vk_mobail_fix_nav_related_options[ link_url ]',
    			'type'        => 'text',
    		  )
    	);

      // link_blank セッティング
      $wp_customize->add_setting( 'vkExUnit_sns_options[ link_blank ]', array(
          'default'			      => false,
          'type'				      => 'option', // 保存先 option or theme_mod
          'capability'		    => 'edit_theme_options', // サイト編集者
      ...
      // link_blank コントロール
      $wp_customize->add_control( 'link_blank', array(
          'label'		=> __( 'Open link new tab.', $vk_mobile_fix_nav_textdomain ),
          'section'	=> 'vk_mobail_fix_nav_related_setting',
          'settings' => 'vkExUnit_sns_options[ link_blank ]',
          'type'		  => 'checkbox',
          )
      );
