...
if ( ! class_exists( 'VK_Post_Type_Manager' ) ) {
	...
	class VK_Post_Type_Manager {
		...
		public static function add_meta_box_action() {
			...
			echo '<label><input type="checkbox" id="veu_post_type_export_to_api" name="veu_post_type_export_to_api" value="true"' . esc_html( $checked ) . '> ' . esc_html__( 'Corresponds to the block editor ( Export to REST API / optional )', 'vk_post_type_manager_textdomain' ) . '</label>';
			...
			for ( $i = 1; $i <= 5; $i++ ) {
				...
				echo '<td><label><input type="checkbox" id="veu_taxonomy[' . esc_attr( $i ) . '][rest_api]" name="veu_taxonomy[' . esc_attr( $i ) . '][rest_api]" value="true"' . esc_attr( $checked ) . '> ' . esc_html__( 'Corresponds to the block editor ( Export to REST API / optional )', 'vk_post_type_manager_textdomain' ) . '</label></td>';
				echo '</tr>';
