	...
	class Widget_Area_Setting {
		...
		public static function resister_customize( $wp_customize ) {
			...
			$wp_customize->add_section(
				'widget_area_setting',
				array(
					'title'    => $widget_area_setting_prefix . __( 'Widget Area Setting', 'widget_area_settng_textdomain' ),
					'priority' => 512,
				)
			);
			...
			$wp_customize->add_control(
				new Custom_Html_Control(
					...
					'footer-upper-widget-area',
					array(
						'label'            => __( 'Widget area of upper footer', 'widget_area_settng_textdomain' ),
			...
			$wp_customize->add_control(
				'lightning_widget_setting[footer_upper_widget_padding_delete]',
				array(
					'label'    => __( 'Delete Padding', 'widget_area_settng_textdomain' ),
					'section'  => 'widget_area_setting',
			...
			$wp_customize->add_control(
				new Custom_Html_Control(
					...
					'footer-widget-area',
					array(
						'label'            => __( 'Footer widget area', 'widget_area_settng_textdomain' ),
						'section'          => 'widget_area_setting',
						'type'             => 'text',
						'custom_title_sub' => '',
						'custom_html'      => '',
			...
			$wp_customize->add_control(
				'lightning_widget_setting[footer_widget_area_count]',
				array(
					'label'    => __( 'Footer Widget Area Count', 'widget_area_settng_textdomain' ),
					'section'  => 'widget_area_setting',
